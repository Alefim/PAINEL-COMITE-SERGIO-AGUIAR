...
export default function Dashboard() {
  ...
  const casasVisitadas = pesquisasApuradas;
    ...
    <div className="dashboard-main">
      ...
      {erro ? <div className="error-state">{erro}. Verifique se a planilha está compartilhada para leitura por link.</div> : <>
        <section className="metrics">
          ...
          <article className="metric-card"><span className="metric-label">Casas visitadas</span><strong className="metric-value">{casasVisitadas.toLocaleString("pt-BR")}</strong><div className="metric-detail">Total de votos para Deputado Estadual</div></article>
        </section>
